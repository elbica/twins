...
export default class EmployeeMainScreen extends Component{
    render(){
        return(
            <View>
                <View style={styles.sectionContainer}>
                    ...
                    <View style={styles.elem}>
                        <View>
                            ...
                            <TouchableOpacity onPress={this.gotoSecond} style={styles.Button1}>
                    ...
                    <TouchableOpacity onPress={this.gotoSecond} style={styles.Button2}>
                        <Icon name="plus"></Icon><Text children={'업무 내용 등록'} style={styles.Text2}></Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={this.gotoSecond} style={styles.Button2}>
                        <Icon name="plus"></Icon><Text children={'연장 근무 사전 신청'} style={styles.Text2}></Text>
                    </TouchableOpacity>
                </View>
            </View>
        );
